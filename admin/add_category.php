<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $res = $common->categoryInsert($category);
        $msg= "";
        if ($res) {
            $msg = "Category successfully insert";
            echo "<script>
                    setTimeout(function() {
                            ...
                            <form method="post" action="" class="form-horizontal">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="fname" name="category" placeholder="Category Name Here">
                                        </div>
                                    </div>
